...
const transpileCssToJs = async (cssEntryPath: string, plugins: Config["plugins"] = []) => {
  ...
  await fs.writeFile(
    path.join(
      ...
      "generated",
      changeExtension(path.basename(cssEntryPath), ".ts"),
    ),
